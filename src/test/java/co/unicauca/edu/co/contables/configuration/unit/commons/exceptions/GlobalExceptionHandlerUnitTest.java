...
class GlobalExceptionHandlerUnitTest {
    ...
    void testHandleHttpMessageNotReadable_GenericError() {
        // Arrange
        HttpMessageNotReadableException exception = new HttpMessageNotReadableException("Error de parsing",
                (Throwable) null, null);
    ...
    void testHandleHttpMessageNotReadable_InvalidFormatException() {
        ...
        HttpMessageNotReadableException exception = new HttpMessageNotReadableException("Error", invalidFormatException,
                null);
    ...
    void testHandleHttpMessageNotReadable_IncludesGenericErrorCode() {
        // Arrange
        HttpMessageNotReadableException exception = new HttpMessageNotReadableException("Error", (Throwable) null,
                null);
