...
public class CostCenterInUseException extends BaseBusinessException {
    ...
    /**
     * @brief Constructor con código específico del centro de costo para eliminación
     *
     * Crea una excepción específica cuando se intenta eliminar un centro de costo
     * que tiene movimientos contables asociados, identificándolo por su código.
     * @param costCenterCode el código del centro de costo que está en uso
     */
    ...
    /**
     * @brief Constructor con código específico del centro de costo para edición
     *
     * Crea una excepción específica cuando se intenta editar un centro de costo
     * que tiene movimientos contables asociados.
     * @param costCenterCode el código del centro de costo que está en uso
     ...
     * estándar para centros de costo en uso.
     */
